...
import { Search, Calendar, Activity } from 'react-feather'; 
...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="p-6 bg-gradient-to-r from-blue-[75] to-blue-50 min-h-screen flex flex-col items-center">
      {/* Page Title */}
      <h1 className="text-4xl font-bold text-blue-800 mb-4">Welcome to Your Dashboard</h1>
      <p className="text-lg text-gray-600 mb-8">Manage your clubs, explore activities, and stay updated with upcoming events.</p>
      ...
      <Tabs defaultValue="registered-clubs" className="w-full max-w-4xl bg-white">
        ...
        <TabsContent value="registered-clubs" className="p-6 bg-blue-50">
          <h2 className="text-2xl font-semibold text-blue-800">Your Registered Clubs</h2>
          <p className="text-gray-600 mb-4">These are the clubs you are a part of. Stay active and engaged!</p>
          {filteredClubs.map(club => (
            ...
            >
              <div>
                ...
                <p className="text-sm text-gray-500">Explore this club and its activities.</p>
              </div>
        ...
        <TabsContent value="upcoming-events" className="p-6 bg-blue-50">
          ...
          <p className="text-gray-600 mb-4">Don't miss out on these events happening soon!</p>
